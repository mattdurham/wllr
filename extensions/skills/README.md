...
- `get_skill` accepts `{ "name": string }`, using the exact skill name from
  frontmatter (for example `bob:work-simple`), and returns the skill body as
  plain text with frontmatter stripped.
