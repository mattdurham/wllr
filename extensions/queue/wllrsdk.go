...
// OnShutdown registers a handler called before the host closes extensions.
// Handlers should flush buffered state and release external resources.
...
func OnContextUsage(
	fn func(inputTokens, outputTokens, contextWindow int64, percent float64, compacted bool, thresholdPct float64, compactions int),
) {
