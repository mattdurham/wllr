...
The `statusline` installed extension owns the status-line scene area. It reads live harness state through `get_status_info` and renders the status row using the scene-graph UI, keeping status presentation out of the core.
